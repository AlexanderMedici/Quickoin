        ...
        <div className="flex  flex-col  md: flex-row w-full justify-center items-center gradient-bg-services">
            <div className="flex mf:flex-row flex-col items-center justify-between md: p-20 p-y12 px-4">
                <div className="flex-1 flex-col justify-start items-start ">
                    <h1 className="text-white text-3xl sm: text:5xlpy-2 text-gradient">
                        Services that we 
                        <br />
                        continue to improve
                    </h1>
            ...
            <div className="flex-1 flex flex-col justify-start items-center">
                <ServiceCard
                    ...
                    subtitle="Security is guaranteed. We always maintain your privacy and ensure you receive  quality service  "
                />
                   <ServiceCard
                    color="bg-[#8945F8]"
